...
provider_reader_entity.icon = "__LTN_Content_Reader_Redux__/graphics/icons/ltn-provider-reader.png"
...
provider_reader_item.icon = "__LTN_Content_Reader_Redux__/graphics/icons/ltn-provider-reader.png"
...
requester_reader_entity.icon = "__LTN_Content_Reader_Redux__/graphics/icons/ltn-requester-reader.png"
...
requester_reader_entity.sprites = make_4way_animation_from_spritesheet(
  { layers =
    {
      {
        filename = "__LTN_Content_Reader_Redux__/graphics/entity/ltn-requester-reader.png",
        width = 58,
        height = 52,
        frame_count = 1,
        ...
        {
          scale = 0.5,
          filename = "__LTN_Content_Reader_Redux__/graphics/entity/hr-ltn-requester-reader.png",
          width = 114,
          height = 102,
          frame_count = 1,
          shift = util.by_pixel(0, 5),
...
requester_reader_item.icon = "__LTN_Content_Reader_Redux__/graphics/icons/ltn-requester-reader.png"
...
delivery_reader_entity.sprites = make_4way_animation_from_spritesheet(
  { layers =
    {
      {
        filename = "__LTN_Content_Reader_Redux__/graphics/entity/ltn-delivery-reader.png",
        width = 58,
        height = 52,
        frame_count = 1,
        shift = util.by_pixel(0, 5),
